...
@Module({
  imports: [CommonModule ,TypeOrmModule.forFeature([UserKelas, Mentor, Kelas, User, Pertemuan, Absen, Kategori, Minggu, ProgresMinggu, JenisKelas, Nilai, Quiz, JawabanTugas, ProgresPertemuan, Pembayaran]), PertanyaansModule, JawabanUsersModule, UsersModule],
