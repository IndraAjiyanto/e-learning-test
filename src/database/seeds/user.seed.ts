...
async function bootstrap() {
  ...
  const kategoris = await kategoriRepository.save([
    {
  ...
  const jenisKelasList = await jenisKelasRepository.save([
    {
  ...
  const kelasList = await kelassRepository.save([
    {
