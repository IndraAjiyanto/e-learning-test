...
async function bootstrap() {
  ...
  const categories = await categoryRepository.save([
    {
      name: 'Short Class',
      icon: 'short.png',
      description: ['class free', 'class free', 'class free'],
      type: 'Free Program',
    },
    {
      name: 'Course',
      icon: 'course.png',
      description: ['class advance', 'class advance', 'class advance'],
      type: 'Free Program',
    },
    {
      name: 'Bootcamp',
    ...
    {
      name: 'In House Training Program',
      icon: 'inhouse.png',
      description: [
  ...
  const courseTypes = await courseTypeRepository.save([
    {
