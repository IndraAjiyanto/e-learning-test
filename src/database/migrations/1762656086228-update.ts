...
export class Update1762656086228 implements MigrationInterface {
    name = 'Update1762656086228'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."pertanyaan_umum_for_enum" AS ENUM('wip', 'internship', 'general', 'short_class', 'bootcamp', 'course')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."pertanyaan_umum_for_enum"`);
