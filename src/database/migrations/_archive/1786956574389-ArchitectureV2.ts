...
export class ArchitectureV21786956574389 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "user_email" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "user_name" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "course_name" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "voucher_code" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "uuid" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "UQ_2c540326a039a91fa7e942caed7" UNIQUE ("uuid")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "voucher" ADD "url_code" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "voucher" ADD CONSTRAINT "UQ_ca236f1dbd4aaf11b317ea67f62" UNIQUE ("url_code")`,
    );
    await queryRunner.query(
      `ALTER TABLE "voucher" ADD "allowed_user_ids" json`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "voucher" DROP COLUMN "allowed_user_ids"`,
    );
    await queryRunner.query(
      `ALTER TABLE "voucher" DROP CONSTRAINT "UQ_ca236f1dbd4aaf11b317ea67f62"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" DROP CONSTRAINT "UQ_2c540326a039a91fa7e942caed7"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" DROP COLUMN "voucher_code"`,
    );
