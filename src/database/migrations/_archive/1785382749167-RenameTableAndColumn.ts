...
export class RenameTableAndColumn1785382749167 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE installment_month_enum_new AS ENUM ('3');`,
    );
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS "kategori_blog" CASCADE;`);
    await queryRunner.query(
      `DROP TABLE IF EXISTS "kategori_jenis_kelas_jenis_kelas" CASCADE;`,
    );
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "pertanyaan_program" CASCADE;`,
    );
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "progres_pertemuan" CASCADE;`,
    );
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "type_program_category" CASCADE;`,
    );
    ...
    await queryRunner.query(
      `TRUNCATE TABLE migrations RESTART IDENTITY CASCADE;`,
    );
  }
