...
export class Update1762764225649 implements MigrationInterface {
    name = 'Update1762764225649'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "visi_misi" ("id" SERIAL NOT NULL, "visi" character varying NOT NULL, "misi" text NOT NULL, "icon" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_65e9a18f1ddbe914a33849b0597" PRIMARY KEY ("id"))`);
