...
export class PisahkanInvoiceDariPayment1787041510551 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gallery" ALTER COLUMN "no" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "invoice" ADD CONSTRAINT "FK_03ccf846238db85401525e07cd2" FOREIGN KEY ("paymentId") REFERENCES "payments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "invoice" DROP CONSTRAINT "FK_03ccf846238db85401525e07cd2"`);
        await queryRunner.query(`ALTER TABLE "gallery" ALTER COLUMN "no" DROP NOT NULL`);
