...
export class Update1762839313708 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "visi_misi" ("id" SERIAL NOT NULL, "visi" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_65e9a18f1ddbe914a33849b0597" PRIMARY KEY ("id"))`);
