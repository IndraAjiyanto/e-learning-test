        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 40px 20px; text-align: center; background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border-radius: 8px 8px 0 0;">
              ...
              <p style="margin: 10px 0 0; color: #e2e8f0; font-size: 14px;">Email Verification</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 16px; color: #475569; font-size: 16px; line-height: 1.6;">
                Thank you for registering at Kesatria Academy 🎉  
              ...
              <div style="padding: 20px; background-color: #f0f9ff; border-left: 4px solid #0ea5e9; border-radius: 6px; margin: 24px 0;">
                <p style="margin: 0; color: #075985; font-size: 14px; line-height: 1.6;">
                  <strong>ℹ️ Important:</strong> This verification link may expire soon. 
