...
export class UsersController {
  ...
  async profile(@Res() res: Response, @Req() req: Request) {
    ...
    const userWithCourses = await this.usersService.findCompletedCoursesByUser(req.user.id);
    return res.render('user/user_profile/index', { user: user, portfolio, userWithCourses });
  }
